...
print("For the program's input, paste the google maps link of your business(es); go to google.com/maps, search for your business in the sidebar, and then click it. When you would like to stop the input process, enter 0.")

# Receiving Input
while True:
    a = input("Insert full urls: ")
    if (a != "0"):
        urls.append(a)
    else:
        break
